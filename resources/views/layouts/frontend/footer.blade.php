                ...
                <div class="row no-gutters">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <form action="{{route('auth.singup')}}" method="post">
                                @csrf
                                <div class="form-group d-flex flex-wrap justify-content-between" style="justify-content:space-evenly">
                                    <span class="toggle">
                                        <input type="radio" id="choice1" name="choice" value="Employee" checked>
                                        <label for="choice1"><h5>Employee</h5></label>
                                        <input type="radio" id="choice2" name="choice" value="Employer">
                                        <label for="choice2"><h5>Employer</h5></label>
                                    </span>
                                </div>
